/*
 * ******************************************************************* Copyright (c) 2005, 2017 Contributors. All rights
 * reserved. This program and the accompanying materials are made available under the terms of the Eclipse Public
 * License v1.0 which accompanies this distribution and is available at http://eclipse.org/legal/epl-v10.html
 ******************************************************************/
...
public class Java15AnnotationFinder implements AnnotationFinder, ArgNameFinder
{
	...
	static
	{
		try
		{
			useCachingClassLoaderRepository =
				System.getProperty("Xset:bcelRepositoryCaching", "true").equalsIgnoreCase("true");
		}
		catch (Throwable t)
		{
	...
	public AnnotationAJ getAnnotationOfType(UnresolvedType ofType, Member onMember)
	{
		...
		try
		{
			...
			org.aspectj.apache.bcel.classfile.annotation.AnnotationGen[] anns =
				new org.aspectj.apache.bcel.classfile.annotation.AnnotationGen[0];
